...
The `danialmazan/elections` Pages repository serves the `/elections/` path on the custom domain. Build and copy the artifact into a local checkout of that repository:

```sh
./scripts/publish-to-site.sh /absolute/path/to/elections-pages-repository
```
